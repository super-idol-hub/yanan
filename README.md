...
> 制作中，尚未正式发布。形象与“黑白日常”造型已由用户确认；完整动作、程序验证及发布状态见 [QA 报告](docs/QA_REPORT.md)。

<img src="docs/visual/identity-anchor.png" alt="已确认的颜安黑白日常造型" width="264">

遵循 [Super Idol Hub Windows 互动角色开发规范](https://github.com/super-idol-hub/idol-windows-character-guides)。首发目标为一个 EXE 内置一套完整造型：24 行、176 张 528 × 808 RGBA 关键帧和双向动作网格。
